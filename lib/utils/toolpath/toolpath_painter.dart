// lib/utils/toolpath/toolpath_painter.dart
...
void paint(Canvas canvas, Size size) {
  ...
  // Add visualization for margin if it exists in settings
  if (settings.margin != null && settings.margin! > 0) {
    ...
    // Add a note about the margin
    final textPainter = TextPainter(
      text: TextSpan(
        text: 'Margin: ${settings.margin!.toStringAsFixed(1)} mm',
        style: TextStyle(
          color: Colors.black,
          fontSize: 14,
