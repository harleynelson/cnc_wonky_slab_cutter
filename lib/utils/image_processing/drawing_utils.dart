...
static void visualizeContourWithInfo(
  ...
  static void _fillPolygon(img.Image image, List<CoordinatePointXY> points, img.Color color) {
    if (points.length < 3) return;
  ...
  static void drawContours(
    img.Image image,
    List<List<CoordinatePointXY>> contours,
    img.Color color,
    {int thickness = 1}
  ) {
