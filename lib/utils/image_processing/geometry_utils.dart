...
class GeometryUtils {
  ...
  static double distance(CoordinatePointXY p1, CoordinatePointXY p2) {
    final dx = p2.x - p1.x;
    final dy = p2.y - p1.y;
  ...
  /// Calculate distance between two points
  static double distanceBetween(CoordinatePointXY a, CoordinatePointXY b) {
    final dx = b.x - a.x;
    final dy = b.y - a.y;
    return math.sqrt(dx * dx + dy * dy);
  }
  ...
  static double squaredDistance(CoordinatePointXY p1, CoordinatePointXY p2) {
    final dx = p2.x - p1.x;
    final dy = p2.y - p1.y;
    return dx * dx + dy * dy;
  }
  ...
  static List<CoordinatePointXY> simplifyPolygon(List<CoordinatePointXY> points, double epsilon, {int maxDepth = 100}) {
  ...
  static List<CoordinatePointXY> findLinePolygonIntersections(CoordinatePointXY p1, CoordinatePointXY p2, List<CoordinatePointXY> polygon) {
  ...
  static double _perpendicularDistance(CoordinatePointXY point, CoordinatePointXY lineStart, CoordinatePointXY lineEnd) {
    try {
  ...
  static List<CoordinatePointXY> _douglasPeucker(List<CoordinatePointXY> points, double epsilon, int depth, int maxDepth) {
    if (points.length <= 2) return List.from(points);
  ...
  static bool isPointOnLineSegment(CoordinatePointXY point, CoordinatePointXY lineStart, CoordinatePointXY lineEnd) {
  ...
  static CoordinatePointXY? lineIntersection(CoordinatePointXY line1Start, CoordinatePointXY line1End, CoordinatePointXY line2Start, CoordinatePointXY line2End) {
  ...
  static CoordinatePointXY? lineSegmentIntersection(CoordinatePointXY line1Start, CoordinatePointXY line1End, CoordinatePointXY line2Start, CoordinatePointXY line2End) {
  ...
  static double polygonArea(List<CoordinatePointXY> points) {
  ...
  static double polygonPerimeter(List<CoordinatePointXY> points) {
  ...
  static bool isPointInPolygon(CoordinatePointXY point, List<CoordinatePointXY> polygon) {
  ...
  static List<CoordinatePointXY> convexHull(List<CoordinatePointXY> points) {
  ...
  static double _ccw(CoordinatePointXY a, CoordinatePointXY b, CoordinatePointXY c) {
    return (b.x - a.x) * (c.y - a.y) - (b.y - a.y) * (c.x - a.x);
  }
  
  /// Calculate the bounding box of a set of points
  static Map<String, double> calculateBoundingBox(List<CoordinatePointXY> points) {
    if (points.isEmpty) {
      return {
        'minX': 0.0,
        'minY': 0.0,
