...
class RegionSample {
  final CoordinatePointXY position;
...
class MultiTapDetectionUtils {
  ...
  static List<CoordinatePointXY> findContourWithRegionSamples(
    img.Image image,
  ...
  static List<List<int>> _extractRegionColors(img.Image image, CoordinatePointXY center, int radius) {
