  ...
  Future<void> _processRegionSamples() async {
    ...
    try {
      ...
      final machineContour = MachineCoordinateSystem.fromMarkerPointsWithDistances(
        CoordinatePointXY(0, 0), // Origin at (0,0) in corrected image
        CoordinatePointXY(widget.settings.markerXDistance, 0), // X-axis at marker distance
        CoordinatePointXY(0, widget.settings.markerYDistance), // Y-axis at marker distance
