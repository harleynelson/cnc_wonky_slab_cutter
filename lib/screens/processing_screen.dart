...
// // Screen for processing images through a step-by-step flow with combined marker and slab detection
...
//             subtitle: Text('Detecting markers and slab contour'),
//             content: Container(),
//             isActive: flowManager.state != ProcessingState.notStarted,
//             state: _getStepState(flowManager.state, ProcessingState.imageProcessing),
//           ),
//           Step(
...
//       case ProcessingState.imageProcessing:
//         return _buildImageProcessingView(flowManager);
//       case ProcessingState.gcodeGeneration:
//       case ProcessingState.completed:
...
//   Widget _buildImageProcessingView(ProcessingFlowManager flowManager) {
...
//                         flowManager.result.processedImage != null
...
//             // Interactive detection button
//             if (contourResult == null)
//               ElevatedButton.icon(
//                 icon: Icon(Icons.find_in_page),
//                 label: Text('Detect Slab Contour'),
...
//     return flowManager.state == ProcessingState.imageProcessing && flowManager.result.markerResult != null ||
//            flowManager.state == ProcessingState.completed;
//   }
...
//     if (flowManager.state == ProcessingState.imageProcessing && 
//         flowManager.result.contourResult == null) {
//       // Go directly to interactive contour detection if no contour yet
