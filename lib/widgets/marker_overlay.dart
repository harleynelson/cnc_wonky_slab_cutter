...
void paint(Canvas canvas, Size size) {
  ...
  // Draw connection lines only when we have all required markers
  if (markers.length >= 3) {
    ...
    // Draw lines if we have at least origin, x-axis and scale markers
    if (originMarker != null && xAxisMarker != null && scaleMarker != null) {
      ...
      // Draw base lines
      canvas.drawLine(originDisplay, xAxisDisplay, linePaint);
      canvas.drawLine(originDisplay, scaleDisplay, linePaint);
      
      // If we have top-right marker too, complete the rectangle
      if (topRightMarker != null) {
        ...
        canvas.drawLine(xAxisDisplay, topRightDisplay, linePaint);
        canvas.drawLine(scaleDisplay, topRightDisplay, linePaint);
      }
    }
  }
}
