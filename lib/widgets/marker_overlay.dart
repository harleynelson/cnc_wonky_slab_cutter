...
class MarkerPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    if (markers.length >= 4) {
      ...
      // If we have all markers, draw connecting lines
      if (originMarker != null && xAxisMarker != null && scaleMarker != null && topRightMarker != null) {
        ...
        final topRightDisplay = MachineCoordinateSystem.imageToDisplayCoordinates(topRightPoint, imageSize, size);
        ...
        canvas.drawLine(
          Offset(xAxisDisplay.x, xAxisDisplay.y), 
          Offset(topRightDisplay.x, topRightDisplay.y), 
          linePaint
        );
